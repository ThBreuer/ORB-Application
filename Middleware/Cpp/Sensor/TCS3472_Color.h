...
//*******************************************************************
#ifndef _TCS3472_COLOR_H
#define _TCS3472_COLOR_H
...
*/
class TCS3472_Color : public Sensor
{
  public:
    //---------------------------------------------------------------
  ...
  public:
    ...
    */
    TCS3472_Color( SensorPort port )
    : Sensor(port, 1 /*Sensor::TCS3472_COLOR*/)
    {
      init();
      kalib();
    }
  ...
  public:
    ...
    */
    ...
    //---------------------------------------------------------------
    /*! Schwarz-Kalibration des Sensors
    ...
    */
    Color_type getColor()
    {
      ...
      if( S > 25 && V >  8  /*<<< quick hack, sensor to close to surface */ && V < 100 /*>>>*/) // Farbe
      {
        if( 315 /*300*/ <= H || H <  45 /*60*/ )
          return( RED );
        if( 45 /*60*/  <= H && H < 180 )
          return( GREEN );
        return( BLAU );
